-- Fix phone column in admin users list: the app stores phone numbers in
-- public.profiles.phone_number (set during onboarding / profile edit), while
-- auth.users.phone is only populated for phone-OTP signups and is always empty here.
