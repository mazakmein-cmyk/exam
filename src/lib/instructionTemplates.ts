...
export const GENERAL_INSTRUCTION_TEMPLATES: InstructionTemplate[] = [
  {
    ...
    text: {
      en: [
        ...
        "",
        "10. Sections and timing depend on the exam: you may sit one section at a time — each with its own timer, and a submitted section cannot be reopened — or all sections may share one timer that lets you move between them freely, or the paper may be split into timed parts where the sections within a part share one timer. The start screen tells you which applies to this paper.",
      ...
      hi: [
        ...
        "",
        "10. खंड और समय की व्यवस्था परीक्षा पर निर्भर करती है: आप एक समय में एक ही खंड हल कर सकते हैं — हर खंड का अपना टाइमर, और सबमिट किया गया खंड दोबारा नहीं खुलता — या सभी खंडों का एक साझा टाइमर हो सकता है जिसमें आप उनके बीच स्वतंत्र रूप से आ-जा सकते हैं, या प्रश्नपत्र समयबद्ध भागों में बँटा हो सकता है जहाँ एक भाग के खंड एक साझा टाइमर पर चलते हैं। शुरू करने से पहले स्टार्ट स्क्रीन बताती है कि इस प्रश्नपत्र में कौन-सी व्यवस्था लागू है।",
